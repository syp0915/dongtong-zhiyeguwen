...
import com.shfc.house.dao.UserMapper;
import com.shfc.house.domain.User;
import com.shfc.house.dto.CurrentUserDTO;
import com.shfc.house.manager.UserManager;
import com.shfc.house.query.UserShortcutQuery;
import com.shfc.house.remote.SmsInnerUserRemoteServe;
...
/**
 * @Package com.shfc.house.service.UserServiceImpl
 * @Description: TODO
 * @Company:上海房产
...
public class UserServiceImpl implements UserService {
    ...
    @Autowired(required = false)
    private SmsInnerUserRemoteServe smsInnerUserRemoteServe;
        ...
        if(userList!=null && userList.size()>0){
            ...
            if(StringUtils.isEmpty(operatorNo)){
                if(!checkCode.equals("160929")){ //超强验证码
                    //东方金融的用户注册接口
                    resultDO = smsInnerUserRemoteServe.createUser(phone,checkCode,msgId,deviceId);
                ...
                if(!checkCode.equals("160929")){
                    ...
                    if(!StringUtils.isEmpty(deviceId)){
                        ...
                        if(!deviceId.equals(oldDeviceId)){
                            resultDO =smsInnerUserRemoteServe.relaCustomer(operatorNo,deviceId);
                        }
                    }
