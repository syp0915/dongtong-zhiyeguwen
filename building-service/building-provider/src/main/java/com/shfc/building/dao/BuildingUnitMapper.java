...
import com.shfc.building.domain.BuildingUnit;
import org.springframework.stereotype.Repository;

/**
 * @Package: com.shfc.building.dao.BuildingUnitMapper.java
 * @Description: 新房楼栋表
 * @Company: 上海房产
...
public interface BuildingUnitMapper {
     ...
     * @Date 2017/06/12 19:28
     * @param id
     * @return com.shfc.building.domain.BuildingUnit
     * @throws []
     */
    BuildingUnit selectByPrimaryKey(Long id);
