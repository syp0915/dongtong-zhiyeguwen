...
/**
 * @Package BuildingProviderMain
 * @Description: TODO
 * @Company:上海房产
 * @Copyright: Copyright (c) 2016
 * Author lv bin
 * @date 2016/12/29 9:17
 * version V1.0.0
 */
public class BuildingMain {
    private static final Logger logger = LoggerFactory.getLogger(BuildingMain.class);
